# 🏗️ System Design: 29-game-snake-net

**Repository #29 | Game Application Architecture**

## 📐 Architecture Overview

This document outlines the system architecture for scaling 29-game-snake-net into a production SaaS application.
...
- Cloudflare CDN
- Estimated cost: 290/month

### Phase 2: 1K-10K Users
- Load balancer + 2 app servers
- PostgreSQL with read replica
- Redis for caching
- Estimated cost: 29-game-snake-net00/month
...
|-----------|-----|--------|------------|
| Compute | 29-game-snake-net0 | 0 | game00 |
| Database | 29-game-snake-net5 | 29-game-snake-net00 | 00 |
| CDN |  | 0 | 2900 |
| Monitoring | ../generate-architecture.sh | 0 | 2900 |
| **Total** | **game0** | **2950** | **29-game-snake-net200** |
